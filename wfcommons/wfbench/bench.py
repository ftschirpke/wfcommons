...
class WorkflowBenchmark:
    ...
    def create_benchmark_from_synthetic_workflow(
        ...
        for task in self.workflow.tasks.values():
            ...
            task_memory = max(int(round(100 / 0.7)), task_memory) if mem else 100  # with read-write bounds in wfbench.py, a minimum memory is required
